      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="inner">
              ...
              <nav>
                <ul class="nav masthead-nav">
                  ...
                  <li><a href="SvServicioVer" >VerServicios</a></li>
          ...
          <div class="inner cover">
            <h1 class="cover-heading">Alta de servicios.</h1>
            
            <form action="SvServicioAlta" method="POST">
            <p>Ingrese los datos del Servicio/p>
            <p><label>Nombre de servicio: </label><input class="entries" type="text" name="nombre"></p>
            <p><label>Descripción : </label><input class="entries" type="text" name="descripcion_breve"></p>
            <p><label>Destino del servicio: </label><input class="entries" type="text" name="destino_servicio"></p>
            <p><label>Fecha del Servicio: </label><input class="entries" type="date" name="fecha_servicio"></p>
            <p><label>Costo del Servicio: </label><input class="entries" type="text" name="costo_servicio"></p>
            <p><label>Disponibilidad?: </label><input class="entries" type="text" name="disponibilidad"></p>
