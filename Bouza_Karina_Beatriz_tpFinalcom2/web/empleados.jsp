...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <title>Empleados Alta module</title>
      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="inner">
              ...
              <nav>
                <ul class="nav masthead-nav">
                  ...
                  <li><a href="SvEmpleadoVer" >VerPersonas</a></li>
          ...
          <div class="inner cover">
            ...
            <p><label>Cargo: </label><input class="entries" type="text" name="cargo" required></p>
            <p><label>Sueldo: </label><input class="entries" type="text" name="sueldo" required></p>
            ...
            <p><label>Usuario: </label><input class="entries" type="text" name="user"required></p>
            <p><label>Contraseña</label><input class="entries" type="password" name="pass"required></p>
            <p><label>Estado</label><input class="entries" type="text" name="estado"required></p>
