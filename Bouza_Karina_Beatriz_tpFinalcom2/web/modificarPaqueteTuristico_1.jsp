...
<html lang="es"><head>
    ...
    <body>
        ...
        <form action="SvModificarPaquete" method="post"> </form>
            ...
            <div class="site-wrapper-inner">
                ...
                <div class="cover-container">
                    ...
                    <div class="inner cover">
                        ...
                        <br>
                        <% 
                            List<ServicioTuristico> lista_servicios_incluidos = (List) misession.getAttribute("listaServicios");
                             List<PaqueteTuristico> lista_paquetes = (List) misession.getAttribute("paquete");
                        %>
                                ...
                                <div class="rwd">    
                                    ...
                                    <table class="rwd_auto">
                                        ...
                                        <tbody>
                                            ...
                                            <%for (PaqueteTuristico un_paquete : lista_paquetes) {
